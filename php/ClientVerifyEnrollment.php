...
<head>
    ...
    <body>
        ...
        <section class="main" id="s1">
            <div>
                <form id="fregister" name="fregister" method="POST" enctype="multipart/form-data">
...
$soapclient = new nusoap_client( 'https://ehusw.es/jav/ServiciosWeb/comprobarmatricula.php?wsdl',
true);
//Llamamos la función que habíamos implementado en el Web Service
//e imprimimos lo que nos devuelve
if(isset($_REQUEST['dirCorreo'])){
    echo '<p>Eres vip? ' . $soapclient->call('comprobar',array('x'=>$_POST['dirCorreo'])) . '</p>';
}
?>
            </div>  
            <div>
